...
@Component({
  selector: 'app-carga-documento-motocicleta',
  templateUrl: './carga-documento-motocicleta.component.html',
  styleUrls: ['./carga-documento-motocicleta.component.css']
})
export class CargaDocumentoMotocicletaComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['Paz y SalvoGestionMotocicleta/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
