...
@Component({
  selector: 'app-carga-documento-inscripcion-dignatarios',
  templateUrl: './carga-documento-inscripcion-dignatarios.component.html',
  styleUrls: ['./carga-documento-inscripcion-dignatarios.component.css']
})
export class CargaDocumentoInscripcionDignatariosComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['InscripcionDignatariosGestion/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
