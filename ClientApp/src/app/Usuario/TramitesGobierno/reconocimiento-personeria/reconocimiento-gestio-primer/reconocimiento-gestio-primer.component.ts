...
@Component({
  selector: 'app-reconocimiento-gestio-primer',
  templateUrl: './reconocimiento-gestio-primer.component.html',
  styleUrls: ['./reconocimiento-gestio-primer.component.css']
})
export class ReconocimientoGestioprimerGradoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.creacionDocumentosprimergrado();
