...
@Component({
  selector: 'app-carga-documento-segundo',
  templateUrl: './carga-documento-segundo.component.html',
  styleUrls: ['./carga-documento-segundo.component.css']
})
export class CargaDocumentosegundoGradoComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['ReconocimientoGestionsegundoGrado/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
