...
@Component({
  selector: 'app-carga-documento-cancelacion-PJuridica',
  templateUrl: './carga-documento-cancelacion-PJuridica.component.html',
  styleUrls: ['./carga-documento-cancelacion-PJuridica.component.css']
})
export class CargaDocumentoCancelacionPJuridicaComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['CancelacionGestionPJuridica/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
