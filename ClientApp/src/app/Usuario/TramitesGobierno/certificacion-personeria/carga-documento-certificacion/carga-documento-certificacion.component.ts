...
@Component({
  selector: 'app-carga-documento-certificacion',
  templateUrl: './carga-documento-certificacion.component.html',
  styleUrls: ['./carga-documento-certificacion.component.css']
})
export class CargaDocumentoCertificacionComponent implements OnInit {
  ...
  regresar()
  {
    this.router.navigate(['CertificacionGestion/'+this.route.snapshot.paramMap.get('codt')]).then(
      () =>
      {
