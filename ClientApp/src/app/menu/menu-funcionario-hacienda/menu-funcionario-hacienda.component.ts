...
@Component({
  selector: 'app-menu-funcionario-hacienda',
  templateUrl: './menu-funcionario-hacienda.component.html',
  styleUrls: ['./menu-funcionario-hacienda.component.css']
})
export class MenuFuncionarioHaciendaComponent implements OnInit {
  ...
  DatosPersonalesH() {
    this.router.navigate(['DatosPersonalesHacienda']);
  }
}
