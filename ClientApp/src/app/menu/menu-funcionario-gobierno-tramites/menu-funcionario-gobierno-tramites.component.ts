...
@Component({
  selector: 'app-menu-funcionario-gobierno-tramites',
  templateUrl: './menu-funcionario-gobierno-tramites.component.html',
  styleUrls: ['./menu-funcionario-gobierno-tramites.component.css']
})
export class MenuFuncionarioGobiernoTramitesComponent implements OnInit {
  ...
  DatosPersonalesT() {
    this.router.navigate(['DatosPersonalesT']);
  }
}
