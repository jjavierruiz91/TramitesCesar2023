...
@Component({
  selector: 'app-menu-funcionario-tic',
  templateUrl: './menu-funcionario-tic.component.html',
  styleUrls: ['./menu-funcionario-tic.component.css']
})
export class MenuFuncionarioTICComponent implements OnInit {
  ...
  DatosPersonalesTIC() {
    this.router.navigate(['DatosPersonalesTIC']);
  }
}
