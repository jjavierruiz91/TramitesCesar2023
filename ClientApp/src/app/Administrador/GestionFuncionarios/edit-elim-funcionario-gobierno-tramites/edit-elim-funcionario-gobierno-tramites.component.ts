...
@Component({
  selector: 'app-edit-elim-funcionario-gobierno-tramites',
  templateUrl: './edit-elim-funcionario-gobierno-tramites.component.html',
  styleUrls: ['./edit-elim-funcionario-gobierno-tramites.component.css']
})
export class EditElimFuncionarioGobiernoTramitesComponent implements OnInit {
