...
@Component({
  selector: 'app-edit-elim-funcionario-tic',
  templateUrl: './edit-elim-funcionario-tic.component.html',
  styleUrls: ['./edit-elim-funcionario-tic.component.css']
})
export class EditElimFuncionarioTicComponent implements OnInit {
