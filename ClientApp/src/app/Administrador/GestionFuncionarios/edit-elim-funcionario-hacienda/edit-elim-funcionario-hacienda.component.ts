...
@Component({
  selector: 'app-edit-elim-funcionario-hacienda',
  templateUrl: './edit-elim-funcionario-hacienda.component.html',
  styleUrls: ['./edit-elim-funcionario-hacienda.component.css']
})
export class EditElimFuncionarioHaciendaComponent implements OnInit {
