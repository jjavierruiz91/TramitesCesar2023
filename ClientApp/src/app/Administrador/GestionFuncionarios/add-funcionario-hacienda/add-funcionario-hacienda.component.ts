...
@Component({
  selector: 'app-add-funcionario-hacienda',
  templateUrl: './add-funcionario-hacienda.component.html',
  styleUrls: ['./add-funcionario-hacienda.component.css']
})
export class AddFuncionarioHaciendaComponent implements OnInit {
