...
@Component({
  selector: 'app-add-funcionario-gobierno-tramites',
  templateUrl: './add-funcionario-gobierno-tramites.component.html',
  styleUrls: ['./add-funcionario-gobierno-tramites.component.css']
})
export class AddFuncionarioGobiernoTramitesComponent implements OnInit {
