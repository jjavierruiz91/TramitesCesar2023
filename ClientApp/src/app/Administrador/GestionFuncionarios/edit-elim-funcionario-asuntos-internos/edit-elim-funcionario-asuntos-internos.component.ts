...
@Component({
  selector: 'app-edit-elim-funcionario-asuntos-internos',
  templateUrl: './edit-elim-funcionario-asuntos-internos.component.html',
  styleUrls: ['./edit-elim-funcionario-asuntos-internos.component.css']
})
export class EditElimFuncionarioAsuntosInternosComponent implements OnInit {
