...
@Component({
  selector: 'app-add-funcionario-asuntos-internos',
  templateUrl: './add-funcionario-asuntos-internos.component.html',
  styleUrls: ['./add-funcionario-asuntos-internos.component.css']
})
export class AddFuncionarioAsuntosInternosComponent implements OnInit {
