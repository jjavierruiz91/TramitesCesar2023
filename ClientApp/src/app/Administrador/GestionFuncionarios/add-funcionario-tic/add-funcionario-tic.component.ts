...
@Component({
  selector: 'app-add-funcionario-tic',
  templateUrl: './add-funcionario-tic.component.html',
  styleUrls: ['./add-funcionario-tic.component.css']
})
export class AddFuncionarioTicComponent implements OnInit {
