...
@Component({
  selector: 'app-tic-edit-elim-funcionario-gobierno',
  templateUrl: './tic-edit-elim-funcionario-gobierno.component.html',
  styleUrls: ['./tic-edit-elim-funcionario-gobierno.component.css']
})
export class TICEditElimFuncionarioGobiernoComponent implements OnInit {
