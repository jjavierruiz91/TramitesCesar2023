...
@Component({
  selector: 'app-tic-edit-elim-funcionario-hacienda',
  templateUrl: './tic-edit-elim-funcionario-hacienda.component.html',
  styleUrls: ['./tic-edit-elim-funcionario-hacienda.component.css']
})
export class TICEditElimFuncionarioHaciendaComponent implements OnInit {
