...
@Component({
  selector: 'app-tic-add-funcionario-hacienda',
  templateUrl: './tic-add-funcionario-hacienda.component.html',
  styleUrls: ['./tic-add-funcionario-hacienda.component.css']
})
export class TICAddFuncionarioHaciendaComponent implements OnInit {
  ...
  getAllUsuarios() {
    this.servicioUsuario.getUsuario().subscribe(useri => {
      ...
      for (let index = 0; index < this.usuarios.length; index++) {
        ...
        if (element.rol == "FuncionarioHacienda") {
