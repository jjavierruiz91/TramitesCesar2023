...
@Component({
  selector: 'app-tic-add-funcionario-gobierno-tramites',
  templateUrl: './tic-add-funcionario-gobierno-tramites.component.html',
  styleUrls: ['./tic-add-funcionario-gobierno-tramites.component.css']
})
export class TICAddFuncionarioGobiernoTramitesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.registerForm = this.formBuilder.group({
      ...
      'rol': ["FuncionarioGobiernoTramites"],
  ...
  getAllUsuarios() {
    this.servicioUsuario.getUsuario().subscribe(useri => {
      ...
      for (let index = 0; index < this.usuarios.length; index++) {
        ...
        if (element.rol == "FuncionarioGobiernoTramites") {
