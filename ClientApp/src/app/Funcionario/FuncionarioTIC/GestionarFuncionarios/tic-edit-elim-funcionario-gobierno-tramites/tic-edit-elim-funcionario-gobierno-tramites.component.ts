...
@Component({
  selector: 'app-tic-edit-elim-funcionario-gobierno-tramites',
  templateUrl: './tic-edit-elim-funcionario-gobierno-tramites.component.html',
  styleUrls: ['./tic-edit-elim-funcionario-gobierno-tramites.component.css']
})
export class TICEditElimFuncionarioGobiernoTramitesComponent implements OnInit {
