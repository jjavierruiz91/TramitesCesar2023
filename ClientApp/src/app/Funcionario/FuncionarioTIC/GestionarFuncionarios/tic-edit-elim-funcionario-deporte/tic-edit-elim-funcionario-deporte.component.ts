...
@Component({
  selector: 'app-tic-edit-elim-funcionario-deporte',
  templateUrl: './tic-edit-elim-funcionario-deporte.component.html',
  styleUrls: ['./tic-edit-elim-funcionario-deporte.component.css']
})
export class TICEditElimFuncionarioDeporteComponent implements OnInit {
