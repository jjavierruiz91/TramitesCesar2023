...
@Component({
  selector: 'app-tic-add-funcionario-gobierno',
  templateUrl: './tic-add-funcionario-gobierno.component.html',
  styleUrls: ['./tic-add-funcionario-gobierno.component.css']
})
export class TICAddFuncionarioGobiernoComponent implements OnInit {
