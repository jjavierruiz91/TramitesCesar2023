...
@Component({
  selector: 'app-tic-add-funcionario-deporte',
  templateUrl: './tic-add-funcionario-deporte.component.html',
  styleUrls: ['./tic-add-funcionario-deporte.component.css']
})
export class TICAddFuncionarioDeporteComponent implements OnInit {
