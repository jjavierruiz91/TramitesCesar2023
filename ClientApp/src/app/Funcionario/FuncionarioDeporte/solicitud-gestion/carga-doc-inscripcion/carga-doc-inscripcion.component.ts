...
@Component({
  selector: 'app-carga-doc-inscripcion',
  templateUrl: './carga-doc-inscripcion.component.html',
  styleUrls: ['./carga-doc-inscripcion.component.css']
})
export class CargaDocInscripcionComponent implements OnInit {
  ...
  update(): void {
    ...
    if (this.registerForm.invalid) {
      ...
      this.authService.ActualizarDocumentoCF(this.documento);
  ...
  regresar() {
    this.router.navigate(['GestionSolicitudes/' + this.route.snapshot.paramMap.get('codSol')]).then(
      () => {
  ...
  get(): void {
    var id =
      +this.route.snapshot.paramMap.get('codDoc');
